...
const Social = () => (
  <div className="socialContainer">
    <ul className="socialUl">
      ...
      <li className="linkedin socialLi"><a href="https://www.linkedin.com/in/adrianladrellthomas/" target="_blank" rel="noopener noreferrer"><i className="fa fa-linkedin" aria-hidden="true"></i></a></li>
    </ul>
  </div>
)
